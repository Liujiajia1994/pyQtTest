...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 60, 401, 285))
        ...
        self.gray_image = QtWidgets.QLabel(self.layoutWidget)
        self.gray_image.setObjectName("gray_image")
        self.verticalLayout.addWidget(self.gray_image)
        ...
        self.widget.setGeometry(QtCore.QRect(450, 60, 331, 281))
        ...
        self.feature_info = QtWidgets.QScrollArea(self.widget)
