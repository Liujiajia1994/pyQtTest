...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.extract.setGeometry(QtCore.QRect(150, 450, 75, 31))
        self.extract.setObjectName("extract")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 60, 369, 373))
        ...
        self.image_preshow = QtWidgets.QLabel(self.layoutWidget)
        self.image_preshow.setObjectName("image_preshow")
        self.verticalLayout.addWidget(self.image_preshow)
        self.label_show = QtWidgets.QLabel(self.layoutWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.image_preshow.setText(_translate("MainWindow", "预览："))
